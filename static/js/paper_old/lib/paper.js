/*!
 * Paper.js v0.9.3 - The Swiss Army Knife of Vector Graphics Scripting.
 * http://paperjs.org/
 *
 ...
 * All rights reserved.
 *
 * Date: Sun Jun 16 12:53:30 2013 -0700
 *
 ***
 *
...
var Matrix = Base.extend({
	...
	scale: function(scale, center) {
		var _scale = Point.read(arguments),
			_center = Point.read(arguments, 0, 0, true); 
		if (_center)
...
var Palette = Base.extend(Callback, {
	_events: [ 'onChange' ],
